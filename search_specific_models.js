...
async function main() {
    try {
        ...
        console.log('Searching for all models starting with employee...');
        ...
        console.log('Employee Models:', JSON.stringify(models, null, 2));

        console.log('Searching for all models starting with hr.appraisal...');
        const appraisalModels = await call('object', 'execute_kw', [
            uid, ODOO_CONFIG.API_KEY,
            'ir.model', 'search_read',
            [[['model', '=ilike', 'hr.appraisal%']]],
            { fields: ['model', 'name'] }
        ]);
        console.log('Appraisal Models:', JSON.stringify(appraisalModels, null, 2));
