...
import { fetchRequisitionRelationOptions } from '../../api/RequisitionsService';
import type { RequisitionField } from '../../types/requisition';

interface RequisitionDynamicFieldRendererProps {
...
const RequisitionDynamicFieldRenderer: React.FC<RequisitionDynamicFieldRendererProps> = ({ field, value, onChange, readonly = false }) => {
    ...
    const loadOptions = async () => {
        ...
        const res = await fetchRequisitionRelationOptions(field.relation, [], 100);
...
export default RequisitionDynamicFieldRenderer;
