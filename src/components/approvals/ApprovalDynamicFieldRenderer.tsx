...
import { fetchApprovalRelationOptions } from '../../api/ApprovalsService';
import type { ApprovalField } from '../../api/ApprovalsService';

interface ApprovalDynamicFieldRendererProps {
    field: ApprovalField;
    value: any;
...
const ApprovalDynamicFieldRenderer: React.FC<ApprovalDynamicFieldRendererProps> = ({ field, value, onChange, readonly = false }) => {
    ...
    const loadOptions = async () => {
        ...
        const res = await fetchApprovalRelationOptions(field.relation, [], 100);
...
export default ApprovalDynamicFieldRenderer;
