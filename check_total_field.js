...
async function checkTotalField() {
    const res = await odooCall('approval.request', 'fields_get', [['x_studio_total_amount']], { attributes: ['readonly', 'states'] });
    console.log('Total Amount Field:', JSON.stringify(res.result, null, 2));
}
checkTotalField();
