...
async function checkFields() {
    const res = await odooCall('approval.product.line', 'fields_get', [['description', 'product_id', 'quantity', 'product_uom_id', 'x_studio_product_description', 'x_studio_per_unit_price', 'x_studio_estimated_price']], { attributes: ['required', 'string'] });
    console.log('Field Attributes:', JSON.stringify(res.result, null, 2));
}
checkFields();
